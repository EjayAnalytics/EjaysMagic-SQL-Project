...
--(1, 'Amara', 'Okafor', 'amara.okafor@example.com', '07123456001'),
--(2, 'Daniel', 'Brooks', 'daniel.brooks@example.com', '07234567002'),
--(3, 'Chioma', 'Adeyemi', 'chioma.adeyemi@example.com', '07345678003'),
--(4, 'Sophie', 'Bennett', 'sophie.bennett@example.com', '07456789004'),
--(5, 'Tolu', 'Williams', 'tolu.williams@example.com', '0756789005'),
--(6, 'Grace', 'Mensah', 'grace.mensah@example.com', '07678901006'),
--(7, 'Michael', 'Carter', 'michael.carter@example.com', '07789012007'),
--(8, 'Adaeze', 'Johnson', 'adaeze.johnson@example.com', '07890123008'),
--(9, 'Emily', 'Clarke', 'emily.clarke@example.com', '07901234009'),
--(10, 'Kent', 'Morgan', 'kent,morgan@example.com', '07012345010')
